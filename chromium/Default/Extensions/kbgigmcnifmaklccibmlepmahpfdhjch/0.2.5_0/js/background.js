...
container.define("bridge", ["addonMessager", "manifest", "env", "config", "storage", "runtime", "oneMigration", "oneGm", "oneStore", "oneProxy", "oneCookie", "oneMenu"], function (addonMessager, manifest, env, config, storage, runtime, oneMigration, oneGm, oneStore, oneProxy, oneCookie, oneMenu) {
    var obj = {};
