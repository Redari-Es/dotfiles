...
container.define("oneProxy", ["addon", "manifest", "notify", "proxy", "proxyMatch", "proxyPac", "proxyAuth", "proxyRule", "factory"], function (addon, manifest, notify, proxy, proxyMatch, proxyPac, proxyAuth, proxyRule, factory) {
    var obj = {
        timer: null,
        modes: {
    ...
    obj.getProxyStatus = function () {
        return obj.getProxyDao().get("proxy_status") == "off" ? "off" : "on";
    };
    ...
    obj.setAuthUrl = function (storeUrl) {
        obj.getProxyDao().set("auth_url", storeUrl);
    };
    ...
    obj.setProxyWithRuleList = function (ruleList) {
        return new Promise(function (resolve) {
            ...
            if (addon.isChrome) {
                proxy.setPacScript(proxyPac.buildPacScript(ruleList)).then(resolve);
            } else {
