container.define("oneCdn", ["calendar", "storage", "$"], function (calendar, storage, $) {
    var obj = {
        sources: {
            staticfile: "https://cdn.staticfile.org/moment.js/2.27.0/locale/zh-cn.min.js",
            bootcdn: "https://cdn.bootcdn.net/ajax/libs/moment.js/2.27.0/locale/zh-cn.min.js",
            cloudflare: "https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.27.0/locale/zh-cn.min.js",
            cdnjs: "https://libs.cdnjs.net/moment.js/2.27.0/locale/zh-cn.min.js"
        }
    };

    obj.getCdn = function () {
        var cdnName = storage.getValue("cdn_name");
        return cdnName ? cdnName : "";
    };
    ...
    obj.matchCdn = function () {
        return new Promise(function (resolve) {
            var promiseList = [];
            for (var name in obj.sources) {
                promiseList.push(obj.testCdn(name, obj.sources[name]));
            }
...
container.define("oneData", ["svgCrypt", "crypto", "env", "http", "oneCdn"], function (svgCrypt, crypto, env, http, oneCdn) {
    ...
    obj.requestOneApi = function (url, data, callback) {
        http.ajax({
            ...
            url: url,
            dataType: "json",
            data: Object.assign({ cdn: oneCdn.getCdn() }, env.getInfo(), data),
    ...
    obj.requestOneJson = function (url) {
        return new Promise(function (resolve) {
            http.ajax({
                ...
                type: "post",
                dataType: "json",
                data: Object.assign({ cdn: oneCdn.getCdn() }, env.getInfo()),
                timeout: 5000,
                success: function (response) {
